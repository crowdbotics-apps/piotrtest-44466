...
export const api_v1_city_list = createAsyncThunk("cities/api_v1_city_list", async payload => {
  const response = await apiService.api_v1_city_list(payload);
  return response.data;
});
export const api_v1_city_create = createAsyncThunk("cities/api_v1_city_create", async payload => {
  const response = await apiService.api_v1_city_create(payload);
  return response.data;
});
export const api_v1_city_retrieve = createAsyncThunk("cities/api_v1_city_retrieve", async payload => {
  const response = await apiService.api_v1_city_retrieve(payload);
  return response.data;
});
export const api_v1_city_update = createAsyncThunk("cities/api_v1_city_update", async payload => {
  const response = await apiService.api_v1_city_update(payload);
  return response.data;
});
export const api_v1_city_partial_update = createAsyncThunk("cities/api_v1_city_partial_update", async payload => {
  const response = await apiService.api_v1_city_partial_update(payload);
  return response.data;
});
export const api_v1_city_destroy = createAsyncThunk("cities/api_v1_city_destroy", async payload => {
...
const citiesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_city_list.pending, (state, action) => {
